        ...
        while (true) // цикл для прийому вхідних повідомлень
        {
          ...
          switch (message[0]) // викликається певний метод відповідно до назви, яку ми отримади з вхідного повідомлення
          {
            ...
            case "UpdateQuestion":
              ...
              break;
            case "DeleteQuestion":
              DeleteQuestion(message[1]);
              Console.WriteLine(this.ClientObjectId + ": DeleteQuestion");
              break;
            ...
            case "DeleteStudent":
              DeleteStudent();
              Console.WriteLine(this.ClientObjectId + ": DeleteStudent");
              break;
            case "LogOut":
